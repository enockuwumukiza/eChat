...
import { AddCircle, ArrowBack, MoreVertOutlined, Search, Cancel, Forum, People, Palette, Notifications } from '@mui/icons-material';
import { Divider, IconButton, Tooltip,  } from '@mui/material';
import { useSelector, useDispatch } from 'react-redux';
import { toast } from 'react-toastify';
import { RootState } from '../store/store';
import { setIsMoreOptionsShown, setIsNewChatShown,setIsGroupChat, setIsSingleChat, setIsNotificationShown } from '../store/slices/displaySlice';
...
const SimpleHeader: React.FC = () => {
    ...
    const isThemesShown = useSelector((state: RootState) => state.display.isThemesShwon);
                ...
                <div className="flex gap-x-8 md:gap-x-40 lg:gap-x-70">
                    ...
                    <div className="flex gap-3 lg:gap-10">
                       ...
                       <Tooltip title="more options">
                        ...
                        <IconButton onClick={() => dispatch(setIsThemesShown(!isThemesShown))}>
                            {
