...
const TopToBottomModal: React.FC<ModalProps> = ({ isOpen, onClose }) => {
  return (
    <div
      className={`fixed inset-0 z-50 bg-black bg-opacity-50 flex ${
        isOpen ? "justify-center items-start" : "hidden"
      }`}
    >
      <div
      ...
      >
        <h2 className="text-xl font-bold mb-4">Top-to-Bottom Modal</h2>
